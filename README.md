...
Now, you will configure the **Hydra** process manager. In order to set up _Hydra_, you need to create a file on the **master** node. This file will contain all the host names of the compute nodes. You can create this file anywhere you want, but for simplicity create it in the _home_ directory of the _jobhandler_ user of the _master_ node.
